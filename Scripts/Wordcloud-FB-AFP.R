...
## AFP Crecer
DATASET_AFPCrecer<- read_csv( "C:/Users/nelso/Downloads/AWS/AWS/NLP/Reports/FB-ENE-JUL-Neg.csv", 
...
wordcloud(words = dfgrouped_AFPcrecer$token, freq = dfgrouped_AFPcrecer$m, min.freq = 10, 
...
graph <- bigramasCrecer %>%
  ...
  filter(n > 7) %>% graph_from_data_frame(directed = FALSE)
set.seed(123)
