...
ds <- read.csv("D:/Workshop DataSphere/Data Profiling en Lenguaje R/ClusterText/ac_data.csv",stringsAsFactors=FALSE)
str(ds)
dim(ds)
...
#Limpiando nuestro Dataset
  ...
  report <- read.csv("D:/Workshop DataSphere/Data Profiling en Lenguaje R/ClusterText/report_lemma.csv",stringsAsFactors=FALSE)
